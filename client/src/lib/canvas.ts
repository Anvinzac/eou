// CanvasSpec — kinetic typography specification.
// Ported from KineMedia so the immersive kinetic canvas can be embedded here.
...
export function getStableCanvasNumber(value: string) {
  let hash = 2166136261;
